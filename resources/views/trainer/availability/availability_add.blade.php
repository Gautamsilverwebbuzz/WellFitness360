	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<br />
					<form id="availabilityForm" name="availabilityForm" action="{{ url('trainer/availability/store') }}"  method="post" class="form-horizontal form-label-left">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="start_time" value="{{ old('start_time') }}" id="start_time" class="form-control col-md-7 col-xs-12" placeholder="Enter start time" autocomplete="off">
